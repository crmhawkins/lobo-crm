    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="fas fa-box"></i><span> Pedidos <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
                        <li><a href="/admin/pedidos">Ver pedidos</a></li>
                        <li><a href="/admin/pedidos-create">Nuevo pedido</a></li>
                        {{-- <li><a href="email-compose.html">Email Compose</a></li> --}}
                    </ul>
                </li>
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="fa-solid fa-wine-bottle"></i><span> Productos <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
                        <li><a href="/admin/productos">Ver productos</a></li>
                        <li><a href="/admin/productos-create">Nuevo producto</a></li>
                        {{-- <li><a href="email-compose.html">Email Compose</a></li> --}}
                    </ul>
                </li>
                <li class="menu-title">Facturación</li>
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="fas fa-hand-holding-usd"></i><span> Facturas <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
                        <li><a href="/admin/facturas">Ver facturas</a></li>
                        <li><a href="/admin/facturas-create">Nueva factura</a></li>
                        {{-- <li><a href="email-compose.html">Email Compose</a></li> --}}
                    </ul>
                </li>
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="fas fa-file"></i><span> Albaranes <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
                        <li><a href="/admin/albaran">Ver albaranes</a></li>
                        <li><a href="/admin/albaran-create">Nuevo albarán</a></li>
                        {{-- <li><a href="email-compose.html">Email Compose</a></li> --}}
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/admin/clientes-create">Nuevo cliente</a></li>
                        {{-- <li><a href="email-compose.html">Email Compose</a></li> --}}
                    </ul>
                </li>
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="fas fa-truck"></i><span> Proveedores <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
                        <li><a href="/admin/proveedores">Ver proveedores</a></li>
                        <li><a href="/admin/proveedores-create">Nuevo proveedor</a></li>
                        {{-- <li><a href="email-compose.html">Email Compose</a></li> --}}
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/admin/usuarios-create">Nuevo usuario</a></li>
                        {{-- <li><a href="email-compose.html">Email Compose</a></li> --}}
                    </ul>
                </li>
