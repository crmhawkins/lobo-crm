    ...
    @case(1)
        <footer class="" style="">
            ...
            <div class="menu_footer_new">
                ...
                <div class="exit-button-col">
                    <a class="footer-button" href="{{ route('productosmarketing.index') }}">
                        <i class="fa-solid fa-wine-bottle"></i>
                        <span>PRODUCTOS MKT</span>
                    </a>
                </div>
                <div class="exit-button-col">
                ...
                <div class="exit-button-col">
                    <a class="footer-button" href="#" data-toggle="dropdown" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="44"
                        height="44" stroke-width="40" stroke="#35a8e0" fill="none">
                            <path d="M64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V160H256c-17.7 0-32-14.3-32-32V0H64zM256 0V128H384L256 0zM80 64h64c8.8 0 16 7.2 16 16s-7.2 16-16 16H80c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64h64c8.8 0 16 7.2 16 16s-7.2 16-16 16H80c-8.8 0-16-7.2-16-16s7.2-16 16-16zm16 96H288c17.7 0 32 14.3 32 32v64c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V256c0-17.7 14.3-32 32-32zm0 32v64H288V256H96z"/>
                        </svg>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{ route('control-presupuestario.proyeccion') }}">Proyección</a></li>
