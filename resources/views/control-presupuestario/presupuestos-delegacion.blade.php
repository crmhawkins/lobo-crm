...
@section('title', 'Control Presupuestario Por Delegaciones')
                        ...
                        <div class="dropdown mb-4">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownDelegaciones">
                                @foreach($delegaciones as $delegacion2)
                                    <li>
                                        <a class="dropdown-item" href="{{ route('control-presupuestario.presupuestos-delegacion', ['delegacion' => $delegacion2->id, 'year' => $year]) }}">
                                            {{ $delegacion2->nombre }}
                                        </a>
                                    </li>
                                @endforeach
