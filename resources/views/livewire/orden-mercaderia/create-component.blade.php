<div class="container-fluid">
    ...
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">TRAMITAR ÓRDEN DE COMPRA DE MERCADERÍA</span></h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-right">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Mercadería</a></li>
                    <li class="breadcrumb-item active">Tramitar órden de compra de mercadería</li>
                </ol>
            </div>
        </div>
    </div>
                                        ...
                                        <tbody>
                                            @foreach ($mercaderias_ordenadas as $productoIndex => $producto)
                                                <tr>
                                                    ...
                                                    <td width="25%">{{ $this->getPrecioIndividual($productoIndex) }} €
                                                    </td>
                                            ...
                                            @endforeach
                                            <tr>
                                                <th colspan="3">Precio estimado total</th>
                                                <th>{{ $precio }} €</td>
                                            </tr>
                                        </tbody>
                                    </table>
