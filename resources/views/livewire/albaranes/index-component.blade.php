        ...
        <div class="col-12">
                            ...
                            <tbody>
                                @foreach ($pedidos_pendientes as $pedido)
                                    <tr>
                                        ...
                                        <td> <a href="albaranes-create/{{ $pedido->id }}" class="btn btn-primary">Preparar pedido</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                                ...
                                @foreach ($pedidos_preparacion as $pedido)
                                    <tr>
                                        ...
                                        <td> <a href="albaranes-edit/{{ $pedido->id }}" class="btn btn-primary">Comprobar pedido</a>
                                            <a href="albaranes-pdf/{{ $pedido->id }}" class="btn btn-primary">Ver albarán</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    @else
                        <h2 class="text-center" style="color: #35a8e0 !important">No hay pedidos en proceso de envío</h2>
                    @endif
